...
def juego_ahorcado():
    ...
    while not juego_terminado and intentos > 0:
        ...
        if '_' not in progreso_actual:
            ...
            print(f"Felicitaicones has ganado, La palabra completa es: '{palabra_secreta}'")
            
    if intentos == 0:
        print(f"Lo sentimos mucho se te han acabado los intentos, la palabra entera es: '{palabra_secreta}'")
